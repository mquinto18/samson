        ...
        <div class="container-fluid">
            ...
            <div id="block_bg" class="block">
                  <div class="navbar navbar-inner block-header">							
								    <div class="muted pull-left"><i class="icon-reorder icon-building"></i> Release Item List</div>
								...
								$return_item = mysqli_query($conn,"select * from release_details 
								 ...
								 LEFT JOIN client ON tbl_release.client_id=client.client_id
								 LEFT JOIN department ON release_details.dep_id=department.dep_id
		                        where release_status='pending' and  remarks='/ Re-used' ORDER BY release_details.release_details_id DESC")or die(mysqli_error());
