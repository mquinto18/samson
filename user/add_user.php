   ...
   <?php
    if (isset($_POST['save'])) {
      ...
      $query = mysqli_query($conn, "SELECT * FROM user WHERE username = '$username' AND password = '$password' AND firstname = '$firstname' AND password = '$password' ") or die("query Failed");
     ...
     <?php
      ...
      ?>
       <script>
         ...
         $.jGrowl("System User Successfully added", {
           header: 'System User add'
         });
       </script>
   <?php
      }
