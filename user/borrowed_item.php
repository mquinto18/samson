	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span9" id="">
				...
				<?php
				$count_dev_name = mysqli_query($conn, "select * from borrowing_form WHERE  approval_status <2 AND borrowers_type = 'user'");
						...
						<div class="span12">
							<form method="post" action="delete_req.php">
								<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
									...
									<tbody>
										<?php
                                        $device_name_query = mysqli_query($conn, "SELECT * FROM borrowing_form WHERE category IN ('Tools', 'Equipment') AND approval_status < 2 AND user_type IN ('student', 'Employee') AND borrowers_type = 'user'") or die("Query Failed");										$cnt = 1;
