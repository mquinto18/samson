        ...
        <div class="container-fluid">
            ...
            <div id="block_bg" class="block">
                  <div class="navbar navbar-inner block-header">							
		                        ...
		                        where release_status='Returned' and item_status = 'Good condition' and remarks=' / Brand new' ORDER BY release_details.release_details_id DESC")or die("query Failed");
	...
	<div class="pull-left">
	    <ul class="nav nav-pills">
		     ...
		     $count_item=mysqli_query($conn,"select * from release_details 
               ...
               ?>
		      <li class="">
			     <a href="view_return.php">All&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
		      </li>
...
<tr>
		...
		<td><?php
			   ...
			   where release_status='Returned' and item_status = 'Good condition' and remarks=' / Brand new'")or die("query Failed");
