	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span9" id="">
				...
				<?php
				$count_dev_name = mysqli_query($conn, "select * from items_available");
						...
						<form id="exportForm" method="post" action="export_available_item.php"> <!--- Export to excel --->
							...
							<form action="delete_item.php" method="post">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
									...
									<tbody>
										<?php
										$device_name_query = mysqli_query($conn, "select * from items_available WHERE item_status = 'Available' ") or die("query Failed");
