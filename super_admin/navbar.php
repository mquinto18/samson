...
<?php
    ...
    $today = date("Y-m-d");
    $overdue_query = "SELECT * FROM borrowing_form WHERE date_return <= '$today' AND approval_status = 1";
    ...
    while ($row = mysqli_fetch_assoc($overdue_result)) {
        ...
        $notification_message .= "<li>$username, the return date for $item_name is today.</li>";
    }
?>
                                    ...
                                    <div class="notif-list">
                                        <?php 
                                            if (mysqli_num_rows($overdue_result) > 0) {
                                                ...
                                                echo  "<div class='notification-new'>$notification_message</div>";
                                            } else {
