	                        ...
	                        ?>	
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
										...
										<a id="return" data-placement="left" title="Click to Return" href="myitem_reuse.php<?php echo '?dep_id='.$dep_id; ?>"><i class="icon-arrow-left"></i> Back</a>
										</div>
									...
									<div class="control-group">
									   ...
									   <div class="control-group">
										...
										$dep_id = $_POST['dep_id'];										
										mysqli_query($conn,"update release_details set										           
										dep_id = '$dep_id'													
										where item_id ='$get_id'")or die(mysqli_error());
													
										mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username',' $client_id Transfer with Item name $get_id to Department ID $dep_id')")or die(mysqli_error());
										?>
										<script>
										window.location = "myitem_reuse.php<?php echo '?dep_id='.$dep_id; ?>"; 
