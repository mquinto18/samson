   <div class="row-fluid">
         ...
         <div class="span12">
           <form method="post" enctype="multipart/form-data">
             <div class="control-group">
               ...
               <div class="controls">
                 <select name="type" id="type" class="chzn-select" required>
                   <option value="">-- Select Type --</option>
                   <option value="ToolCat">Tool Category</option>
     ...
     <!-- /block -->
          ...
          if (isset($_POST['save'])) {
            ...
            move_uploaded_file($_FILES["image"]["tmp_name"], "../main-upload/" . $_FILES["image"]["name"]);
            $thumbnails = "../main-upload/" . $_FILES["image"]["name"];
     ...
     <?php
              ...
              mysqli_query($conn, "insert into department (dep_name,thumbnails,dep_type) values('$dep_name','$thumbnails', '$dep_type')") or die("query Failed");
      ...
      ?>
       <script>
         $.jGrowl("Department Successfully added", {
