...
<html class="no-js">
    <head>
        <title>Tools and Equipment Property Monitoring System (SAMSON)</title>
		<meta name="description" content="Tools and Equipment Property Monitoring System">
		<meta name="author" content="Jonald Remus Sevellejo">
		<meta charset="UTF-8">	
		
        <!-- Bootstrap -->
		<link href="images/samson.png" rel="icon" type="image">
