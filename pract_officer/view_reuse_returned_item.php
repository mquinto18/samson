            ...
            <div id="block_bg" class="block">
                  <div class="navbar navbar-inner block-header">							
								...
								$return_item = mysqli_query($conn,"select * from release_details 
	                             ...
	                             LEFT JOIN tbl_release ON release_details.release_id=tbl_release.release_id
								 LEFT JOIN client ON tbl_release.client_id=client.client_id
		                        where release_status='Returned' and  remarks='/ Re-used' ORDER BY release_details.release_details_id DESC")or die(mysqli_error());
...
<tr>
		...
		<td><?php
			   ...
			   where release_status='Returned' and  remarks='/ Re-used'  ")or die(mysqli_error());
