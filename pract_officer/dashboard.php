...
<body>
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <?php include('sidebars/dashb.php'); ?>
                ...
                <div class="row-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="alert alert-success alert-dismissable">
                            ...
                            <img id="avatar1" class="img-responsive" src="<?php echo $row['adminthumbnails']; ?>"><strong> Welcome! Officer <?php echo $user_row['firstname'] . " " . $user_row['lastname'];  ?></strong>
                        </div>
                    </div>
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                ...
                                <div class="block-content collapse in">
                                    <div id="page-wrapper">
                                        <?php
                                        $stocks = mysqli_query($conn, "select * from items_available where category='Equipment'") or die("query Failed");
                                        ...
                                        <div class="row-fluid">
                                                        ...
                                                        <div class="container-fluid">
                                                            <div class="row-fluid">
                                                                ...
                                                                <div class="span8 text-right"><br />
                                                                    ...
                                                                    <div class="">All Equipments</div><br />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <?php
                                            $result_items_available = mysqli_query($conn, "SELECT * FROM items_available WHERE item_status = 'Available' AND category='Equipment'") or die("Query Failed");
                                            $total_items_available = mysqli_num_rows($result_items_available);

                                            $combined_total = $total_items_available;
                                            ?>
                                            <div class="span6">
                                                    ...
                                                    <div class="panel-heading">
                                                        <div class="container-fluid">
                                                            <div class="row-fluid">
                                                                ...
                                                                <div class="span8 text-right"><br />
                                                                    <div class="huge"><?php echo $combined_total; ?></div>
                                                                    <div>Availabe Equipments</div><br />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div id="page-wrapper">
                                        <div class="row-fluid">
                                            ...
                                            <?php
                                            $Realease = mysqli_query($conn, "select * from borrowing_form where approval_status in (0,1) and category='Equipment'") or die("query Failed");
                                                        ...
                                                        <div class="container-fluid">
                                                            <div class="row-fluid">
                                                                ...
                                                                <div class="span8 text-right"><br />
                                                                    ...
                                                                    <div>Borrowed Equipments</div><br />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
