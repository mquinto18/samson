	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
		...
		<li class="">
			...
			<ul id="bs1" class="collapse">
				...
				<li class="">
					<a href="department.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Add Location</a>
				</li>	
			</ul>
		</li>
		...
		<!------/.* Manage User sidebar*------->
		<li class="">
     			<a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs3"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;Manage Admin User
     				<div class="muted pull-right"><i class="caret"></i></div>
     			</a>
...
-->
		...
		<li class="">
			...
			<ul id="bs5" class="collapse">
				<li class="">
					<a href="report_borrowed.php"><i class="icon-chevron-right"></i><i class="icon-file"></i> Equipment Report</a>
				</li>
			</ul>
		</li>
	</ul>
