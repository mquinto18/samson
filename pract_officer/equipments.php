...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<?php include('sidebars/equipment_sidebar.php'); ?>
			...
			<div class="span9" id="">
				...
				<?php
				$count_dev_name = mysqli_query($conn, "select * from items_available where category = 'Equipment'");
				$count = mysqli_num_rows($count_dev_name);
				?>
				<div id="block_bg" class="block">
					<div class="navbar navbar-inner block-header">
						<div class="muted pull-left"><i class="icon-folder-open-alt"></i>Equipment Item List</div>
						...
						<div class="span12">
							<form action="delete_item.php" method="post">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
									...
									<tbody>
										<?php
										$device_name_query = mysqli_query($conn, "SELECT * FROM items_available WHERE item_status = 'Available' AND category = 'Equipment'") or die("Query Failed");
