	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span9" id="">
				...
				<?php
				$count_dev_name = mysqli_query($conn, "select * from items_available WHERE item_status = 'Not Available' AND category = 'Equipment'");
						...
						<div class="span12">
							...
							<form action="delete_item.php" method="post">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
									...
									<tbody>
										<?php
										$device_name_query = mysqli_query($conn, "select * from items_available  WHERE item_status = 'Not Available' AND category='Equipment'") or die("query Failed");
