...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<?php include('sidebars/masterfile.php'); ?>
			...
			<div class="span9" id="">
				...
				<?php
				$count_dev_name = mysqli_query($conn, "SELECT * FROM items_available WHERE category = 'Equipment' AND item_status='Available' ");
				...
				<div id="block_bg" class="block">
					...
					<div class="block-content collapse in">
						<div class="span12">
						<form id="exportForm" method="post" action="export_available_item.php"> <!--- Export to excel --->
							<button type="submit" id="exportButton" name="export_available_item" class="btn btn-success">Export</button>
						</form>
							<form action="delete_item.php" method="post">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
									...
									<tbody>
										<?php
										$device_name_query = mysqli_query($conn, "SELECT * FROM items_available WHERE category = 'Equipment' AND item_status = 'Available'") or die("query Failed");
