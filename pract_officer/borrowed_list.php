	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span9" id="">
				...
				<?php
				$count_dev_name = mysqli_query($conn, "select * from borrowing_form WHERE approval_status IN (0,1) AND category = 'Equipment'");
						...
						<div class="span12">
							<form method="post" action="delete_req.php">
								<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
									...
									<tbody>
										<?php
										$device_name_query = mysqli_query($conn, "SELECT * FROM borrowing_form WHERE approval_status IN (0,1) AND category = 'Equipment'") or die("query Failed");
										$cnt = 1;
				...
				<div class="table-container">
					<div class="custom-table">
						<table class="">
							...
							<tbody>
								<?php
								$sql = "SELECT * FROM borrowing_form WHERE approval_status = 0 AND category = 'Equipment'";
				...
				<div class="table-container">
					<div class="custom-table">
						<table class="">
							...
							<tbody>
								<?php
								$sql = "SELECT * FROM borrowing_form WHERE approval_status = 1 AND category = 'Equipment'";
								$que = mysqli_query($conn, $sql);
								$cnt = 1;
								while ($result = mysqli_fetch_assoc($que)) {
								?>
