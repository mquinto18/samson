                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header">
                            ...
                            <div class="muted pull-right">
                                <?php
                                $my_department = mysqli_query($conn, "select * from department where dep_type = 'Location' ") or die("query Failed");
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                <ul class="da-thumbs grid-4">
                                    <?php
                                    $query = mysqli_query($conn, "SELECT * FROM department WHERE dep_type = 'Location'") or die("query Failed");
