     <div class="span3" id="sidebar">
                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li class="">						
							<a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bstools"><i class="icon-chevron-right"></i><i class="icon-wrench icon-large"></i>&nbsp;Tools and Equipment
							<div class="muted pull-right"><i class="caret"></i></div>
							</a>					
							<ul id="bstools" class="collapse">						
								<li class="">
									<a href="tools.php"><i class="icon-chevron-right"></i><i class="icon-wrench"></i>&nbsp;Tools</a>
								</li>
								<li class="">
									<a href="equipments.php"><i class="icon-chevron-right"></i><i class="icon-cogs"></i>&nbsp;Equipment</a>
								</li>
							</ul>
						</li>
						
						
						 <!------/.* Manage Equipment Location sidebar*------->	
						  <li class="active">						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs1"><i class="icon-chevron-right"></i><i class="icon-sitemap icon-large"></i>&nbsp;Manage Equipment Location
						    <div class="muted pull-right"><i class="caret"></i></div></a>					
						    <ul id="bs1" class="collapse">						
                            <li class="">
                             <a href="item_department.php"><i class="icon-chevron-right"></i><i class="icon-reorder icon-building"></i> Equipment Location </a>
                            </li>
                            <li class="">
                            <a href="department.php"><i class="icon-chevron-right"></i><i class="icon-reorder icon-building"></i>Add Equipment</a>
                            </li> 					   							
						    </ul>
						</li>
