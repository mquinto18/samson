...
<body>
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <?php include('sidebars/report_sidebar.php'); ?>

            <div class="span9" id="">
                <div class="empty"></div>

                <?php
                $count_dev_name = mysqli_query($conn, "SELECT * FROM borrowing_form WHERE category = 'Equipment'");
                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                ...
                                <tbody id="refresh">
                                    <?php
                                    $device_name_query = mysqli_query($conn, "SELECT * FROM borrowing_form WHERE category = 'Equipment'") or die("query Failed");
                                    $cnt = 1;
