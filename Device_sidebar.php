     <div class="span3" id="sidebar">
                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						 ...
						 <li>						
                            ...
                            <li class="active">
                            <a href="item.php"><i class="icon-chevron-right"></i><i class="icon-desktop"></i> Borrowed Item </a>
                            </li>
                            <li class="">
                ...
                <li class="">
								...
								<li class="">
									<a href="borrowing.php"><i class="icon-chevron-right"></i><i class="icon-share"></i>Borrowed Form</a>
								</li>
						    </ul>
						</li>
					  ...
					  <!------/.* notification sidebar*------->
					    <li class="">
                         ...
                         <li class="">
                           <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs4"><i class="icon-chevron-right"></i><i class="icon-search icon-large"></i>&nbsp;Report 
						   <div class="muted pull-right"><i class="caret"></i></div></a>
                           </a>
