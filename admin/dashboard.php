...
<div id="page-wrapper">
        <?php 
	     $stocks = mysqli_query($conn,"select * from items_available where category='Tools'")or die("query Failed");
		 ...
		 ?>
                <div class="row-fluid">				
                    ...
                    <?php 
                        ...
                        $result_item = mysqli_query($conn, "SELECT * FROM items_available WHERE item_status = 'Available' AND category='Tools'") or die("Query Failed");
                        $total_items = mysqli_num_rows($result_item);
                        
                        $combined_total =  $total_items;
                    ?>
                     <div class="span6">
...
<div id="page-wrapper">
		...
		<?php 
		 ...
		 ?>				
                    ...
                    <?php 
	     $Realease = mysqli_query($conn,"select * from borrowing_form WHERE approval_status IN (0,1) and category='Tools'")or die("query Failed");
