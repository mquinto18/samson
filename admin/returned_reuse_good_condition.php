        ...
        <div class="container-fluid">
            ...
            <div id="block_bg" class="block">
                  <div class="navbar navbar-inner block-header">							
		                        ...
		                        where release_status='Returned' and item_status = 'Good condition' and remarks='/ Re-used' ORDER BY release_details.release_details_id DESC")or die(mysqli_error());
...
<tr>
		...
		<td><?php
			   ...
			   where release_status='Returned' and item_status = 'Good condition' and remarks='/ Re-used'")or die(mysqli_error());
