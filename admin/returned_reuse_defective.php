        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_item=mysqli_query($conn,"select * from release_details 
		                        ...
		                        where release_status='Return' and item_status = 'Defective' and remarks='/ Re-used' ORDER BY release_details.release_details_id DESC");
            ...
            <div id="block_bg" class="block">
                  <div class="navbar navbar-inner block-header">							
								    <div class="muted pull-left"><i class="icon-reorder icon-building"></i> Return Re-Used Item List</div>
		                        ...
		                        where release_status='Returned' and item_status = 'Defective' and remarks='/ Re-used' ORDER BY release_details.release_details_id DESC")or die(mysqli_error());
...
<?php
 ...
 <!-----------------------------------device categorized by their Item status using nav pills------------------------------------>		
<div class="container-fluid">
 <div class="row-fluid">
 <br/> 
	<div class="pull-left">
	    <ul class="nav nav-pills">
		      ...
		      $count_item=mysqli_query($conn,"select * from release_details 
								 ...
								 LEFT JOIN client ON tbl_release.client_id=client.client_id
								 LEFT JOIN department ON release_details.dep_id=department.dep_id
		                        where release_status='Returned' and  remarks='/ Re-used' ORDER BY release_details.release_details_id DESC");
	           $count = mysqli_num_rows($count_item);
               ?>
		      <li class="">
			     <a href="view_reuse_returned_item.php">All&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
		      </li>
		     ...
		     <?php	
	           $count_item=mysqli_query($conn,"select * from release_details 
								 ...
								 LEFT JOIN client ON tbl_release.client_id=client.client_id
								 LEFT JOIN department ON release_details.dep_id=department.dep_id
		                        where release_status='Returned' and item_status = 'Good condition' and remarks='/ Re-used' ORDER BY release_details.release_details_id DESC");
	           $count = mysqli_num_rows($count_item);
               ?>					
				<li class="">
					<a href="returned_reuse_good_condition.php">Good Condition&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
	           ...
	           $count_item=mysqli_query($conn,"select * from release_details 
								 ...
								 LEFT JOIN client ON tbl_release.client_id=client.client_id
								 LEFT JOIN department ON release_details.dep_id=department.dep_id
		                        where release_status='Returned' and item_status = 'Defective' and remarks='/ Re-used' ORDER BY release_details.release_details_id DESC");
	           $count = mysqli_num_rows($count_item);
               ?>					
				<li class="active">
					<a href="returned_reuse_defective.php">Defective&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
	    ...
	    <ul class="nav nav-pills">
               ...
               ?>
		      <li class="">
			     <a href="view_return.php">Brand New&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
		      </li>
               ...
               ?>
				...
				<li class="active">
					<a href="view_reuse_returned_item.php">Re-Used Item&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
...
<tr>
		...
		<td><?php
			   ...
			   where release_status='Returned' and item_status = 'Defective' and remarks='/ Re-used'")or die(mysqli_error());
			   ...
			   {
			  echo '<div class="alert alert-danger"><i class="icon-wrench"></i><strong>'.$row['item_status'].''.$row['remarks'].'</strong></div>';
		       };
			  ?>
		</td>
