				...
				<?php include('item_location_slidebar.php'); ?>
						...
						<div class="span9" id="content">
                          ...
                          <div class="empty">
                              ...
                              <strong>We Strongly Recommed to Please Check the Item</strong>
                            </div>
			               </div>
						   
						    <?php $location_query = mysqli_query($conn,"select * from department	                     
	                         where dep_id = '$dep_id'")or die('query Failed');
	                        ...
	                        ?>	
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
									 ...
									 <?php
									$query1 = mysqli_query($conn,"select * from client where client_id = '$client_id'")or die('query Failed');
									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
										...
										date_return = NOW()
                                        where release_details.item_id ='$get_id'")or die('query Failed');	
													
										mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username',' $client_id Return Item  $get_id to Department ID $dep_id')")or die('query Failed');			
										?>
										<script>
