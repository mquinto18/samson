	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query = mysqli_query($conn,"select * from user where user_id = '$get_id'")or die("query Failed");
								...
								<form method="post">
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" value="<?php echo $row['middlename']; ?>"  name="lastname" id="focusedInput" type="text" placeholder = "Middlename" required>
                                          </div>
                                        </div>
...
mysqli_query($conn,"update user set username = '$username'  , firstname = '$firstname' , middlename = '$middlename', lastname = '$lastname' where user_id = '$get_id' ")or die("query Failed");
mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit system User $firstname $lastname')")or die("query Failed");	
?>
<script>
