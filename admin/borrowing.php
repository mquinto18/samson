...
<body>
    ...
    if (isset($_POST['save'])) {
        ...
        VALUES ('$user_type', '$full_name', '$department', '" . $_POST['other_department'] . "', '$category','$item_borrowed', '$date_borrowed', '$date_return', '$uploadIdFront', '$uploadIdBack', '$approval_status','toolcat')";
