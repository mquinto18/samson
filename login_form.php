						...
						$.ajax({
							...
							success: function(html) {
								if (html == 'true_admin') {
									...
									$.jGrowl("Welcome to Tools and Equipment Property Monitoring System (SAMSON)", {
								...
								} else if (html == 'superadd') {
									$.jGrowl("Welcome to Tools and Equipment Property Monitoring System (SAMSON)", {
										header: 'Access Granted'
									});
									var delay = 1000;
									setTimeout(function() {
										window.location = 'super_admin/dashboard.php'
									}, delay);

								} else if (html == 'officer') {
									$.jGrowl("Welcome to Tools and Equipment Property Monitoring System (SAMSON)", {
										header: 'Access Granted'
									});
									var delay = 1000;
									setTimeout(function() {
										window.location = 'pract_officer/dashboard.php'
									}, delay);
								} else {
